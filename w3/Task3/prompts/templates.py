...
DECOMPOSE_SYSTEM = (
    ...
    "Keys: Intent, Tables, Columns, Filters, Joins.\n"
...
def generation_user_prompt(question: str, decomposition_json: str) -> str:
    return f"Question: {question}\n\nDecomposition:\n{decomposition_json}"


def fix_user_prompt(sql: str, error: str) -> str:
    return f"Failing SQL:\n{sql}\n\nError:\n{error}"
